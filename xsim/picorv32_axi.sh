...
#
# Script generated by Vivado on Sun Jun 21 22:01:59 +0800 2026
...
export RDI_DATADIR="D:/vivado2/2025.2/Vivado/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot picorv32_axi xil_defaultlib.picorv32_axi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim picorv32_axi -key {Behavioral:sim_1:Functional:picorv32_axi} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/vivado2/2025.2/Vivado/data/xsim"
  fi
